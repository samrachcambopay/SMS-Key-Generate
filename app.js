...
const crypto = require('crypto');  // Added for generating a secure session secret

const app = express();
const PORT = process.env.PORT || 1001;

// Securely generate a random session secret
const sessionSecret = crypto.randomBytes(32).toString('hex');

mongoose.connect('mongodb+srv://cbpsmstest:Cambopay2023@cluster0.9yz8ir7.mongodb.net/API_SMS_GEN?retryWrites=true&w=majority', {
